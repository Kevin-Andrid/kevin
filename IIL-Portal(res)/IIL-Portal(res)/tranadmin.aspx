<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/tranadmin.aspx.cs" MasterPageFile="~/ttraining.Master" Inherits="IIL_Portal_res_.tranadmin" %>
...
<asp:Content ID="body" ContentPlaceHolderID="bodytrain" runat="server">
    ...
    <link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="Stylesheet" type="text/css" />
        <div class="header">
            <br />
            <img src="image/Full_Logo_iil_print.png" height="50" width="400">
        </div>
        <div>
            <div class="content_out">
                <div class="box_border">
                    ...
                    <asp:Label ID="errorMsgLabel" runat="server" ForeColor="Red" Font-Names="Segoe UI"></asp:Label>
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="login" OnClick="login_click" Width="110px" /><br />
                        <br />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="newuser" runat="server" ForeColor="Black" Text="Create new account" Font-Names="Segoe UI" Font-Size="Small"></asp:Label>
