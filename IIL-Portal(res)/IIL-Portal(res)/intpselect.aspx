<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="intpselect.aspx.cs" MasterPageFile="~/internship.Master" Inherits="IIL_Portal_res_.intpselect" %>

<asp:Content ID="body" ContentPlaceHolderID="bodyintp" runat="server">
    <link rel="stylesheet" href="bootstudentcss.css" type="text/css" />
    <div class="container">
        <div class="pagehead">
          <label>Internship Select</label>
        </div>
...
<p>
                    ...
                    <p>
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="cd-dropdown"></asp:DropDownList>
                    </p>
                    <p>
                        <label>Batch</label>
